...
public class TestAddMethodInvoke {
    ...
    public void testAop() throws Exception {
        ...
        //替换类字段！
        runner.addClassField("size", java.util.List.class, new Operator() {
            @Override
            public Object executeInner(Object[] list) throws Exception {
                ArrayList arrayList = (ArrayList) list[0];
                System.out.println("拦截到List.size 字段的计算");
                return arrayList.size()+1;
            }
        });
        ...
        express = "list=new ArrayList();list.add(1);list.add(2);list.add(3);return list.size;";
        result = runner.execute(express, context, null, false, false);
        System.out.println(result);
